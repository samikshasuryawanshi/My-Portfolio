        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className='lg:col-span-7 space-y-16'>
            ...
            <div className="space-y-6">
              ...
              <h1 className='reveal-up text-6xl md:text-9xl font-black tracking-tighter leading-[0.85] uppercase'>
                Building <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-zinc-400 to-zinc-800 italic font-extralight uppercase">Great Stuff.</span>
              </h1>
            ...
            <div className='reveal-up space-y-10 max-w-xl'>
              <div className="group relative pl-8 border-l border-zinc-900 hover:border-blue-500 transition-colors duration-500">
                ...
                <p className='text-lg md:text-xl font-light leading-relaxed text-zinc-400'>
                  I'm a student at <span className="text-white font-medium hover:text-blue-400 transition-colors italic">TIT, Bhopal</span> who loves building clean, pixel-perfect websites using <span className="text-zinc-100">React & Next.js</span>.
                </p>
              </div>
              ...
              <div className="group relative pl-8 border-l border-zinc-900 hover:border-purple-500 transition-colors duration-500">
                ...
                <p className='text-lg md:text-xl font-light leading-relaxed text-zinc-400'>
                  I also work on the backend with <span className="text-purple-400">Node.js & Express</span>. I enjoy making apps that are <span className="text-white italic">fast and reliable</span>, with clean <span className="text-white underline decoration-zinc-700 underline-offset-4">APIs</span> that just work.
                </p>
              </div>
            </div>
          ...
          <div className='lg:col-span-5 mt-10 relative flex flex-col items-center justify-center'>
            ...
            <div className='box2 relative transform lg:scale-110'>
              ...
              >
                <span className="text-[8px] font-mono text-blue-400 uppercase tracking-widest">Available for Projects</span>
              </motion.div>
              ...
              <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 bg-zinc-900/50 border border-white/5 p-8 rounded-none backdrop-blur-xl space-y-6 w-[280px] shadow-2xl">
                <div className="flex justify-between items-end">
                  <div className="space-y-1">
                    <div className="text-[8px] font-mono text-zinc-500 uppercase">My Approach</div>
                    <div className="text-xl font-black italic tracking-tighter">SHIP FAST</div>
                  </div>
